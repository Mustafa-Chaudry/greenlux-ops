...
values
  (
    ...
    'partial',
    'under_review',
    (select id from public.rooms where slug = 'room-6' limit 1),
  ...
  (
    ...
    'paid',
    'checked_in',
    (select id from public.rooms where slug = 'room-5' limit 1),
  ...
  (
    ...
    'partial',
    'checked_in',
    (select id from public.rooms where slug = 'apartment-3' limit 1),
  ...
  (
    ...
    'paid',
    'checked_in',
    (select id from public.rooms where slug = 'studio-1' limit 1),
  ...
  (
    ...
    'partial',
    'checked_in',
    (select id from public.rooms where slug = 'room-9' limit 1),
...
values
  ...
  (
    ...
    (select id from public.rooms where slug = 'room-7' limit 1),
