...
const adminAreas = [
  ...
  {
    title: "Rooms",
    description: "Review room inventory, base prices, guest capacity, amenities, and operational status.",
    href: "/admin/rooms",
    icon: Hotel,
  },
  {
  ...
  {
    title: "Maintenance",
    description: "Log room issues, repair costs, status, and resolution notes for daily operations.",
