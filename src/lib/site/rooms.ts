...
export const rooms: PublicRoom[] = [
  {
    ...
    images: [
      "/greenlux/rooms/studio-1-main-new.jpg",
      "/greenlux/rooms/studio-1-lounge-01-new.jpg",
      "/greenlux/rooms/studio-1-lounge-02-new.jpg",
      "/greenlux/rooms/studio-1-1.jpg",
      "/greenlux/rooms/studio-1-5.jpg",
      "/greenlux/rooms/studio-1-terrace-garden-new.jpg",
      "/greenlux/rooms/studio-1-kitchen-new.jpg",
      "/greenlux/rooms/studio-1-bathroom-new.jpg",
      "/greenlux/rooms/studio-1-shower-new.jpg",
    ],
    galleryLabels: [
      "Premium double bed & warm wood paneling",
      "Cosy living area with 65-inch Smart TV",
      "Study desk & seating layout",
      "Living area & private terrace door layout",
      "Lush green private terrace garden",
      "Private terrace seating corner",
      "Private kitchenette with microwave & fridge",
  ...
  },
  {
    ...
    images: [
      "/greenlux/rooms/studio-2-main-new.jpg",
      "/greenlux/rooms/studio-2-bed-01-new.jpg",
      "/greenlux/rooms/studio-2-bed-alternate-new.jpg",
      "/greenlux/rooms/studio-2-1.jpg",
      "/greenlux/rooms/studio-2-4.jpg",
      "/greenlux/rooms/studio-2-terrace-garden-new.jpg",
      "/greenlux/rooms/studio-2-sitting-new.jpg",
      "/greenlux/rooms/studio-2-kitchen-new.jpg",
      "/greenlux/rooms/studio-2-bathroom-new.jpg",
      "/greenlux/rooms/studio-2-shower-new.jpg",
    ],
    galleryLabels: [
      "Boutique double bed & workspace layout",
      "Double bed & ambient bedside lighting",
      "Alternative room angle",
      "Double bed & room layout perspective",
      "Direct sliding door access to common terrace",
      "Dedicated private terrace garden",
      "Dedicated study desk & sitting area",
      "Compact kitchenette with microwave & fridge",
  ...
  },
  {
    ...
    images: [
      "/greenlux/rooms/apartment-3-bed-day.jpg",
      "/greenlux/rooms/apartment-3-bed-lights.jpg",
      "/greenlux/rooms/apartment-3-3.jpg",
      "/greenlux/rooms/apartment-3-dining.jpg",
      "/greenlux/rooms/apartment-3-entrance.jpg",
      "/greenlux/rooms/apartment-3-kitchen-01.jpg",
      "/greenlux/rooms/apartment-3-bathroom.jpg",
      "/greenlux/rooms/apartment-3-shower.jpg",
      "/greenlux/rooms/apartment-3-terrace-01.jpg",
      "/greenlux/rooms/apartment-3-terrace-swing.jpg",
    ],
    galleryLabels: [
      "Master bedroom in bright natural daylight",
      "Master bedroom with ambient evening lights",
      "Spacious separate TV lounge & seating",
      "Dedicated dining table for four",
      "Welcoming apartment entry foyer",
      "Private kitchen with microwave & storage",
  ...
  },
  {
    ...
    images: [
      "/greenlux/rooms/apartment-4-1.jpg",
      "/greenlux/rooms/apartment-4-2.jpg",
      "/greenlux/rooms/Appartment 4 upstairs Lounge.jpeg",
      "/greenlux/rooms/apartment-4-3.jpg",
      "/greenlux/rooms/apartment-4-4.jpg",
      "/greenlux/rooms/apartment-4-5.jpg",
      "/greenlux/rooms/apartment-4-projector-new.jpg",
      "/greenlux/rooms/apartment-4-6.jpg",
    ],
    galleryLabels: [
      "Master bed & upper-level layout",
      "Refined workspace nook & bedroom angle",
      "Upper-level sitting area & secondary lounge",
      "Clean private bathroom",
      "Spacious private kitchen downstairs",
      "Cosy private living room & TV lounge",
      "Private downstairs TV lounge with home cinema projector setup",
      "Private back terrace access",
    ],
  ...
  },
  {
    ...
    images: [
      "/greenlux/rooms/room-5-1.jpg",
      "/greenlux/rooms/room-5-2.jpg",
      "/greenlux/rooms/room-5-3.jpg",
      "/greenlux/rooms/room-5-4.jpg",
      "/greenlux/rooms/room-5-5.jpg",
      "/greenlux/rooms/room-5-6.jpg",
    ],
    galleryLabels: [
      "Main room view",
      "Polished wardrobe & storage",
      "Clean private bathroom",
      "Bed area & reading corner",
      "Alternate room angle",
      "Shared guest lounge access",
    ],
  ...
  },
  {
    ...
    images: [
      "/greenlux/rooms/room-7-1.jpg",
      "/greenlux/rooms/room-7-2.jpg",
      "/greenlux/rooms/room-7-3.jpg",
      "/greenlux/rooms/room-7-4.jpg",
      "/greenlux/rooms/room-7-5.jpg",
      "/greenlux/rooms/room-7-6.jpg",
    ],
    galleryLabels: [
      "Master bed & room layout",
      "Cosy bed area",
      "Polished private bathroom",
      "Alternate room angle",
      "Seating corner",
      "Shared lounge & common access",
    ],
  ...
  },
  {
    ...
    images: [
      "/greenlux/rooms/room-6-1.jpg",
      "/greenlux/rooms/room-6-2.jpg",
      "/greenlux/rooms/room-6-3.jpg",
      "/greenlux/rooms/room-6-5.png",
    ],
    galleryLabels: ["Comfortable double bed", "Desk corner & room view", "Private shower room", "Shared kitchen access"],
  ...
  },
  {
    ...
    images: [
      "/greenlux/rooms/room-10-1.jpg",
      "/greenlux/rooms/room-10-2.jpg",
      "/greenlux/rooms/room-10-3.jpg",
      "/greenlux/rooms/room-10-5.jpg",
      "/greenlux/rooms/room-10-6.jpg",
    ],
    galleryLabels: [
      "Comfortable double bed",
      "In-room refrigerator & desk",
      "Clean private bathroom",
  ...
  },
  {
    ...
    images: [
      "/greenlux/rooms/room-9-1.jpg",
      "/greenlux/rooms/room-9-2.jpg",
      "/greenlux/rooms/room-9-3.jpg",
      "/greenlux/rooms/room-9-4.jpg",
      "/greenlux/rooms/room-9-5.jpg",
      "/greenlux/rooms/room-9-6.jpg",
    ],
    galleryLabels: [
      "Polished double bed",
      "Room layout & wardrobe",
      "Private bathroom",
      "Shared first-floor lounge",
      "Shared dining & kitchen access",
  ...
  },
  {
    ...
    images: [
      "/greenlux/rooms/budget-room-11-1.jpg",
      "/greenlux/rooms/budget-room-11-2.jpg",
      "/greenlux/rooms/budget-room-11-3.jpg",
      "/greenlux/rooms/budget-room-11-4.jpg",
      "/greenlux/rooms/budget-room-11-5.jpg",
      "/greenlux/rooms/budget-room-11-6.jpg",
    ],
    galleryLabels: [
      "Double bed",
